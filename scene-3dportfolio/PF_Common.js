...
const ARCADE_DISPLACEMENT_TO_FOCUS_ON_CAM = FOLLOW_CAM_RADIAL_DISTANCE;
const ARCADE_THRESHOLD_DISTANCE_TO_SWITCH_ON_OFF = 150;

// INTERPOLATION FACTORS FOR SEVERAL OBJECTS BASED ON FPS
const INTERPOLATION_FACTOR_FOR_60_FPS = 0.0375;

// RENDERER_GLOBAL_CONFIG (to be defined when webglrendere is created);
let RENDERER_MAX_ANISOTROPY = undefined;
...
export default {
    ...
    ARCADE_THRESHOLD_DISTANCE_TO_SWITCH_ON_OFF,
    INTERPOLATION_FACTOR_FOR_60_FPS,
    RENDERER_MAX_ANISOTROPY
}